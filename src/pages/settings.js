        ...
        <div id="billing-section">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1rem; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-md); margin-bottom: 1rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem;">
              <div style="width: 36px; height: 24px; background: ${this.profile?.card_brand === 'link' ? '#00D66F' : 'white'}; border: 1px solid var(--border-color); border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 0.625rem; font-weight: 700; color: ${this.profile?.card_brand === 'link' ? 'white' : '#1a1f36'}; text-transform: uppercase;">${this.profile?.card_brand === 'link' ? '<svg width="20" height="10" viewBox="0 0 60 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.2 0h-4v28h4V0zm9.3 7.5c-2.8 0-4.8 1.1-5.9 2.8V7.8h-3.8V28h4v-11c0-3.3 2-5.5 5-5.5 2.8 0 4.5 2 4.5 5.2V28h4V16.2c0-5.3-3.2-8.7-7.8-8.7zM47 28l-7.8-10 7.4-10.2h-4.7l-5.1 7.3-5-7.3h-4.9l7.5 10.2L26.5 28h4.7l5.4-7.5L41.8 28H47z" fill="white"/></svg>' : (this.profile?.card_brand || 'Card')}</div>
              <div>
