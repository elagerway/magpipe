        ...
        <div id="billing-section">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1rem; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-md); margin-bottom: 1rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem;">
              <div style="width: 36px; height: 24px; background: ${this.profile?.card_brand === 'link' ? '#00D66F' : 'white'}; border: ${this.profile?.card_brand === 'link' ? 'none' : '1px solid var(--border-color)'}; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: ${this.profile?.card_brand === 'link' ? '0.5rem' : '0.625rem'}; font-weight: 700; color: ${this.profile?.card_brand === 'link' ? 'white' : '#1a1f36'}; text-transform: uppercase; letter-spacing: 0.5px;">${this.profile?.card_brand === 'link' ? 'LINK' : (this.profile?.card_brand || 'Card')}</div>
              <div>
