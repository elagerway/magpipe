      ...
      <div class="footer-content">
        ...
        <div class="footer-links">
          ...
          <div class="footer-column">
            ...
            <a href="https://github.com/elagerway/magpipe" target="_blank" rel="noopener" class="footer-github-link">
...
export function getPublicFooterStyles() {
  return `
    ...
    .public-footer .footer-github-link {
      display: inline-flex;
      align-items: center;
      gap: 0.4rem;
    }

    .public-footer .footer-github-link svg {
      flex-shrink: 0;
    }
