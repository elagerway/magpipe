...
export function renderBottomNav(currentPath = '/agent') {
  const navItems = [
    ...
    {
      path: '/agents',
      icon: `<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/><circle cx="12" cy="9" r="2" stroke-width="2"/><path stroke-linecap="round" stroke-width="2" d="M8 9h.01M16 9h.01"/></svg>`,
      label: 'Agents'
    },
    {
      path: '/inbox',
