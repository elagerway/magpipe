...
const response = await fetch(
  'https://mtxbiyilvgwhbdptysex.supabase.co/functions/v1/create-chat-widget',
  {
    method: 'POST',
    headers: {
...
```json Success Response
{
  ...
  "collect_visitor_email": true,
  "is_active": true,
  "embed_code": "<script>(function(w,d,s,o,f,js,fjs){w['PatWidget']=o;w[o]=w[o]||function(){(w[o].q=w[o].q||[]).push(arguments)};js=d.createElement(s);fjs=d.getElementsByTagName(s)[0];js.id=o;js.src=f;js.async=1;fjs.parentNode.insertBefore(js,fjs);}(window,document,'script','PatChat','https://magpipe.ai/widget/pat-chat.js'));PatChat('init',{widgetKey:'wgt_a1b2c3d4e5f6789012345678'});</script>",
