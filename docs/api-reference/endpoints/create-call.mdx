...
api: "POST https://mtxbiyilvgwhbdptysex.supabase.co/functions/v1/initiate-bridged-call"
...
<ParamField body="from" type="string" required>
  Your Solo Mobile phone number to use as caller ID. Must be a number provisioned in your account.
...
const response = await fetch(
  'https://mtxbiyilvgwhbdptysex.supabase.co/functions/v1/initiate-bridged-call',
  {
    method: 'POST',
    headers: {
