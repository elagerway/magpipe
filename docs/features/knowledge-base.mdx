...
<Frame caption="Knowledge base dashboard with your indexed sources and sync status">
  <img src="/images/knowledge-base.png" alt="Knowledge base sources" />
</Frame>
...
<Frame caption="The Add Source modal — enter a URL, paste content, or upload a file">
  <img src="/images/knowledge-add-modal.png" alt="Add knowledge source modal" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Paste Content">
    Paste text directly - no URL needed.
  </Tab>
...
<Frame caption="Adding a knowledge source from a URL">
  <img src="/images/add-knowledge-demo.gif" alt="Adding a knowledge source" />
</Frame>
