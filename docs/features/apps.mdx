...
<Frame caption="Connect external services like Slack, Cal.com, and CRMs to extend your agents">
  <img src="/images/apps-integrations.png" alt="Apps and integrations" />
</Frame>

Magpipe has two levels of app configuration:
...
<Frame caption="Configuring Slack channel routing on the Extract Data function">
  <img src="/images/connect-slack-demo.png" alt="Slack channel configuration" />
</Frame>
...
- Route extracted call data to specific channels
...
<Note>
Both public and private channels are supported. For private channels, invite the Magpipe bot to the channel first. If you connected Slack before March 2026, disconnect and reconnect to grant the `groups:read` permission needed for private channels.
</Note>
...
Extract data → Route to specific channels (public or private)
```
