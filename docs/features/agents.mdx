---
title: AI Agents
description: "Create intelligent AI agents that handle calls, texts, chat, and email"
---
...
<Frame caption="The agents dashboard shows all your AI agents at a glance">
  <img src="/images/agents-list.png" alt="Agents list" />
</Frame>

<Frame caption="Creating a new AI agent">
  <img src="/images/create-agent-demo.gif" alt="Creating a new agent" />
</Frame>
...
<Frame caption="Agent detail view — configure your agent's personality, voice, and behavior">
  <img src="/images/agent-detail.png" alt="Agent detail configuration" />
</Frame>

<Frame caption="Scroll through all Configure tab settings">
  <img src="/images/agent-configure-scroll.gif" alt="Agent configure tab scroll" />
</Frame>
...
#### Voice Selection
Choose from 30 AI voices across two providers. Each voice card shows an avatar, audio preview, and trait tags (accent, tone, age, use case, and supported languages).
...
<Frame caption="The Prompt tab — define your agent's personality and conversation behavior">
  <img src="/images/agent-prompt-tab.png" alt="Agent prompt tab" />
</Frame>

<Frame caption="Scroll through the full system prompt configuration">
  <img src="/images/agent-prompt-scroll.gif" alt="Agent prompt scroll" />
</Frame>
...
<Frame caption="The Schedule tab — set business hours, timezone, and after-hours forwarding">
  <img src="/images/agent-schedule-tab.png" alt="Agent schedule tab" />
</Frame>

<Frame caption="Scroll through call and SMS schedule settings">
  <img src="/images/agent-schedule-scroll.gif" alt="Agent schedule scroll" />
</Frame>
...
<Frame caption="The Deployment tab — assign phone numbers, create chat widgets, and connect email">
  <img src="/images/agent-deployment-tab.png" alt="Agent deployment tab" />
</Frame>

<Frame caption="Assigning a phone number to your agent">
  <img src="/images/agent-deployment-demo.gif" alt="Assigning a number" />
</Frame>
...
See [Email Integration](/features/email) for detailed configuration.
...
<Frame caption="The Knowledge tab — manage which knowledge sources your agent can access">
  <img src="/images/agent-knowledge-tab.png" alt="Agent knowledge tab" />
</Frame>
...
<Frame caption="The Analytics tab — track call volume, sentiment, and agent performance">
  <img src="/images/agent-analytics-tab.png" alt="Agent analytics tab" />
</Frame>
