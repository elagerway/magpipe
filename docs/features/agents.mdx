...
AI Agents are the core of Solo Mobile. Each agent is a fully customizable AI assistant with its own personality, voice, knowledge, and behavior. Agents can handle multiple communication channels simultaneously - answering phone calls, responding to SMS messages, and chatting with website visitors.
...
1. Connect Cal.com in Settings → Integrations
