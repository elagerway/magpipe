...
<Frame caption="Assign your agent to a phone number from the Deploy tab">
...
In **Multilingual** mode, the agent detects the caller's language in real time and switches seamlessly — no caller action needed.
