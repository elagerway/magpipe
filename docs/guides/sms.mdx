...
Your Solo Mobile phone numbers can send and receive SMS text messages. Your AI agent handles incoming texts automatically.

## Receiving SMS

When someone texts your Solo Mobile number:
