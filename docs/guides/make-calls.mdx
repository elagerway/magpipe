...
Solo Mobile supports two types of outbound calls:

1. **Agent Call** - AI agent speaks to the recipient
2. **Callback Call** - You speak to the recipient (bridged through Solo Mobile)
...
1. Solo Mobile initiates call to recipient
2. Recipient answers
...
Use this when you want to speak to someone yourself, using your Solo Mobile number as caller ID.
...
<Steps>
  ...
  <Step title="Answer Your Phone">
    Solo Mobile calls YOUR phone first. Answer it.
  </Step>
  <Step title="Connected">
    Once you answer, Solo Mobile bridges you to the recipient.
  </Step>
</Steps>

### Callback Call Flow

1. Solo Mobile calls your registered phone
2. You answer
3. Solo Mobile then calls the recipient
4. When they answer, you're connected
5. Your Solo Mobile number shows as caller ID

## Call Settings

### From Number
Choose which of your Solo Mobile numbers to call from. This affects:
