...
- **For schema changes**: Use `export SUPABASE_ACCESS_TOKEN=YOUR_SUPABASE_ACCESS_TOKEN && npx supabase db push` to apply new migrations without clearing data
...
- **Required Environment Variables**:
  ```bash
  SIGNALWIRE_PROJECT_ID=fb9ea15e-cf87-4de2-8be2-0f619b8e956e
